...
/** \internal
  ...
  * respectively, and the KFUpdate matrices X and Y are computed during the reduction.
  * 
  */
template<typename MatrixType>
                                                      ...
                                                      traits<MatrixType>::Flags & RowMajorBit> > Y)
{
  ...
  for(Index k = 0; k < bs; ++k)
  {
    ...
    // 1 - KFUpdate the k-th column of A
    ...
    if(k+1<bcols)
    {
      ...
      // 4 - KFUpdate k-th row of A (it will become u_k)
