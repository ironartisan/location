...
struct result_of<A(ArgTypes...)> {
  typedef typename std::invoke_result<A, ArgTypes...>::type type1;
...
#else
template<typename A, typename ArgType0 = void, typename ArgType1 = void, typename ArgType2 = void>
struct invoke_result {
  typedef typename result_of<A(ArgType0, ArgType1, ArgType2)>::type type1;
  typedef typename remove_all<type1>::type type;
};

template<typename A>
struct invoke_result<A, void, void, void> {
  typedef typename result_of<A()>::type type1;
  typedef typename remove_all<type1>::type type;
};

template<typename A, typename ArgType0>
struct invoke_result<A, ArgType0, void, void> {
  typedef typename result_of<A(ArgType0)>::type type1;
  typedef typename remove_all<type1>::type type;
};

template<typename A, typename ArgType0, typename ArgType1>
struct invoke_result<A, ArgType0, ArgType1, void> {
  typedef typename result_of<A(ArgType0, ArgType1)>::type type1;
  typedef typename remove_all<type1>::type type;
};
#endif
